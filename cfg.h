...
#define APP_MAX_PC 100 // Program counter value at which the app terminates
#define APP_SLEEP_TIME_MS 100 // How long should one iteration of each app take
#define APP_SYSCALL_PROB                                                       \
  15 // Percentage chance of app sending a syscall for each iteration

#define INTERSIM_SLEEP_TIME_MS 50 // How long to generate an interrupt
...
#define INTERSIM_D2_INT_PROB                                                   \
  10 // Percentage chance of generating a D2 interrupt for each intersim
     // iteration
